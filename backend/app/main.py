...
app.include_router(reservations.router, prefix="/api/reservations", tags=["reservations-compat"])
app.include_router(fines.router, prefix="/api/v1/fines", tags=["fines"])
app.include_router(fines.router, prefix="/api/fines", tags=["fines-compat"])
app.include_router(loans.router, prefix="/api", tags=["circulation-compat"])
